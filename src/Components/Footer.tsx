export default function Footer() {
  ...
  return (
    <footer className=' text-sm sm:text-lg mt-4 border-black flex-col p-4 flex justify-center items-center gap-4 text-blue-500 font-bold'>
      ...
      <p  className="hover:text-blue-500">+917617446649</p>
